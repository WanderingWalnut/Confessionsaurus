  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto py-8 sm:py-12 lg:py-16 relative z-10 confession-form-enter px-4">
        ...
        {/* Instagram link below the form (compact) */}
        <div className="mt-4 flex items-center justify-center">
          <a
            href="https://www.instagram.com/confessionsaurus/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Confessionsaurus on Instagram"
            className="inline-flex items-center"
            style={{ fontSize: 20, color: "#991b1b" }}
          >
            <svg
            ...
            <span style={{ fontSize: 20 }}>instagram.com/confessionsaurus</span>
          </a>
        </div>
      </div>
    </div>
